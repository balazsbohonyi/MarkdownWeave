...
- [x] P5-T11: Image file drag-and-drop (link in place, insert `![](relative/path)`)
- [x] P5-T12: Markdown file drag-and-drop (insert `[name](relative/path)`)
- [x] P5-T13: Generic file drag-and-drop (insert `[name](relative/path)`)
